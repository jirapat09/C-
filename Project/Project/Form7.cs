...
namespace Project
{
    public partial class Form7 : Form
    {
        ...
        private void showhistory()
        {
            ...
            cmd.CommandText = "SELECT name,price,status,username FROM history WHERE username = '"+Program.username+"'";
        ...
        private void showadmin()
        {
            ...
            cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT name,price,status,username FROM history ";
        ...
        private void dataadmin_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            conn.Open();
            MySqlCommand cmd = new MySqlCommand("SELECT image FROM history WHERE name = '" + nameBox.Text + "'", conn);
